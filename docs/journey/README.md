...
2. **The judges** — the Devpost "challenges we ran into" prose pulls from
   these files; this folder is the depth-of-engineering evidence behind it.
3. **Anyone forking this repo** — the SHARP RFC, the Vertex multi-region
   approach, and the fire-and-forget A2A pattern are all transferable.
...
| [05-fhir-and-sharp.md](05-fhir-and-sharp.md) | Empty-bearer-token regression, why we deleted the fixture fallback, RFC PR upstream |
...
| [10-architectural-decisions.md](10-architectural-decisions.md) | Locked-in calls: peer A2A vs orchestrator, 5T framing |
...
**Fix:** what we did
**Why this matters:** the architectural implication
```
